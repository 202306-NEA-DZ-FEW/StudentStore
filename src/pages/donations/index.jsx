        ...
        <div className='p-4 mt-24 flex justify-center flex-col'>
            ...
            <div className='text-[#7874F2] flex flex-col '>
                ...
                {isRTL ? (
                    <p
                        dir='rtl'
                        className='mx-auto text-justify  px-2 text-[20px] sm:px-12 font-semibold w-[85%] md:w-[60%] z-[8] leading-10 sm:text-2xl  pb-2 '
                    >
                    ...
                    <p
                        dir='ltr'
                        className='mx-auto text-justify  px-2 text-[20px] sm:px-12 font-semibold w-[85%] md:w-[60%] z-[8] sm:text-2xl leading-10 pb-2 '
                    >
                        {t("why donating paragraph")}
                    </p>
                )}
